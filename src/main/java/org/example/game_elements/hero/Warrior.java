...
/**
 * Concrete implementation of Hero class named Warrior
 * Represents the rgp-game style class Warrior
...
public class Warrior extends Hero {
    ...
    public Warrior(String name){
        ...
        this.setLevelUpAttribute(new HeroAttribute(3, 2, 1)); // Sets how much attribute values should increase when leveling
     ...
     * Damaging attribute for Warrior: Strength
