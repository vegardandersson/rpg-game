...
/**
 * Concrete implementation of Hero class named Ranger
 * Represents the rgp-game style class Ranger
...
public class Ranger extends Hero {
    ...
    public Ranger(String name){
        ...
        this.setLevelUpAttribute(new HeroAttribute(1, 5, 1)); // Sets how much attribute values should increase when leveling
     ...
     * Damaging attribute for Ranger: Dexterity
